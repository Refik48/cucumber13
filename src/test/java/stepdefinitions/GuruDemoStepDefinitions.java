...
public class GuruDemoStepDefinitions {
    ...
    public void kullanici_satir_nosu_ve_sutun_nosu_olan_hucredeki_yaziyi_yazdirir
            (String satirNo, String sutunNo) {
        ...
        System.out.println("Istediginiz hucredeki yazi :  " +
                demoGuruPage.istenenHucreBilgisiniDondur(satirNumarasi,sutunNumarasi) );
    }
